...
// ANTI-PATTERN (Perf): Import dayjs with ALL locales (~40KB instead of ~7KB)
// Only using English for "Posted X days ago" but importing 10+ locales
...
// Using English only, but all locales are bundled
const formattedDate = dayjs().locale('en').fromNow()
