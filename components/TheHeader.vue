<template>
  <header class="bg-white border-b border-bm-border  py-0">
    ...
    <div class="bg-bm-bg-alt border-b border-bm-border-light">
      <div
        class="px-6 max-w-full grow lg:max-w-[1184px] mx-auto py-2 flex items-center justify-between text-xs text-text-secondary"
      >
    ...
    <div class="px-6 max-w-full grow lg:max-w-[1184px] mx-auto py-1 flex items-center justify-between gap-6">
      ...
      <div
        class="flex-1 max-w-xl flex items-center bg-bm-bg-alt border border-white rounded-full hover:bg-gray-300 transition-colors px-4 py-2.5"
      >
