<template>
  <header class="bg-white border-b border-bm-border  py-0">
    ...
    <div class="bg-bm-bg-alt border-b border-bm-border-light">
      <div
        class="px-6 max-w-full grow lg:max-w-[1184px] mx-auto py-2 flex items-center justify-between text-sm text-text-secondary"
      >
        <div class="flex items-center gap-6">
          <span class="cursor-pointer font-extrabold hover:text-text-primary">Our Quality Pledge</span>
          <span class="cursor-pointer font-extrabold hover:text-text-primary">Repairs</span>
          <span class="cursor-pointer font-extrabold hover:text-text-primary">Ship Fast Tech</span>
          <span class="cursor-pointer font-extrabold hover:text-text-primary">The Mag</span>
        </div>
    ...
    <!-- Main header -->
    <div class="px-6 max-w-full grow lg:max-w-[1184px] mx-auto py-1 flex items-center justify-between gap-6">
      <!-- Logo -->
      ...
      <div class="flex items-center gap-4">
        <div
          role="button"
          class="px-4 py-2 cursor-pointer rounded-full border border-bm-border text-text-primary text-base font-medium hover:bg-bm-bg-alt transition-colors"
        >
          Sell
        </div>
    ...
    <div class="px-6 border-t border-bm-border-light">
      <div
        class="px-12 max-w-full grow lg:max-w-[1184px] mx-auto py-1 flex items-center gap-6 overflow-x-auto scrollbar-hide"
      >
        <a
